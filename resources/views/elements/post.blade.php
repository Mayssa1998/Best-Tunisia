<div class="flex flex-col my-5">
            <div class="bg-white shadow-md  rounded-3xl p-4">
                <div class="flex-none ">
<div class="mx-auto object-cover w-full h-full" wire:offline.class="grayscale">
                    	@foreach($post->postImages as $media)
	                    @if($media->is_image && preg_match('/^.*\.(png|jpg|gif)$/i', $media->path))
                        <img src="{{ url('/storage/' . $media->path) }}"
                            alt="Social" class="mx-auto object-scale-down  rounded-md" onContextMenu="return false;">
